...
1. [Git](#git)
 ...
 1. [Was ist Markdown?](#was-ist-markdown)
     * [Verwendungen in Markdown:](#verwendungen-in-markdown)
----------------------------------------------------------------------------------------------------------------------------------------
...
* **git clone:** Kopie vom local repository möglich
...
Für Aufzälungen setzt man nur ein```*```. Nach dem * Symbol kommt immer ein Leerzeichen.
...
Für Numerierungen setzt man zuerst eine Zahl mit einem Punkt (```1.```). Von hier aus wird von der gegebnen Zahl aus weg nummeriert, dabei ist egal ob man beim zweiten Aufzälungspunkt z.B.: ```100.``` schreibt. NAch dem Aufzälungspunkt kommt immer ein Leerzeichen.
...
### Tabellen:
Eine Tabelle wird mit verschieden Zeichen erstellt.
...
### Links einfügen
In Markdown kann man anklickbare Hyperlinks einfügen. Im angezeigten Text ist der Link enthallten, somit wird er Blau.

Z.B.: ```[jeweiliger Text](dazugehöriger Link)```



### Bilder
Man kann auch Bilder einfügen. Wichtig ist, dass man den Link des Bildes benutzt, nicht den der Website woher das Bild stammen könnte.

Z.B.:```![Text](Link des Bildes)```

![](https://sandmann.co/wp-content/uploads/Was-ist-Markdown-Cover.jpg)       



### Code
Um Code zu schreiben setzt man dreich Hochkomma, dargestellt in dem Fall durch ein Hochkomma Zeichen(``` `Code` ```).Markdown unterstützt auch Syntax-Highlighting. 
...
### Horizontale Linien
Für Horizontale Linien muss man mindesten 3 Bindestriche setzen, jeweils Umgeben von 2 Leerzeilen.


### Inhaltsverzeichnis erstellen
In der Runden Klammer wird alles kleingeschrieben. Die Sonderzeichen werden ignoriert und leerzeichen müssen durch Bindestriche ersetzt werden.

Z.B.:```[Was ist Markdown?](#was-ist-markdown)```
