...
Markdown ist eine vereinfachte Aufzeichnungssprache (Skriptsprache). Ein Ziel von Markdown ist es, schnell und effizient formatierten Text zu schreiben der bei der Ausgangsform ohne viel Konvertieren schon lesbar ist. Als Auszeichnungselemente wurden daher vor allem Auszeichnungsarten verwendet, die in Plain text und E-Mails üblich sind. Auch andere Auszeichnungssprachen mit ähnlichen Zielen zur Lesbarkeit – wie reStructuredText oder Textile – hatten Einfluss auf die Syntax. Der MIME-Type lautet text/markdown.[2]
