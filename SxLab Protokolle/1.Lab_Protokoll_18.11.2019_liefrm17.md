...
### Vorteile:
1. Wenn nächste Version sehr fehlerbehaftet, dann Rückgriff auf vorherige Version möglich
1. Mehrige Personen können zugleich an einer Version arbeiten. Bei Komplikationen ist sichtbar, wer z.B. als letztes an der Version gearbeitet hat. Daher sieht man und kann man beweißen wer und wann er einen oder mehrige Fehler gemacht hat.
1. 
