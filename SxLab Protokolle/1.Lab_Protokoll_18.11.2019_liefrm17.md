...
Für Numerierungen setzt man zuerst eine Zahl mit einem Punkt (```1.```). Von hier aus wird von der gegebnen Zahl aus weg nummeriert, dabei ist egal ob man beim zweiten Aufzälungspunkt z.B.: ```100.``` schreibt.
