...
* **Protokoll nächste Einheit:** [Drittes Protokoll](https://github.com/HTLMechatronics/m17-3ahme-la1-sx/blob/wadkim17/wadkim17/protokolle/2020-01-20-wadkim17.md)
-----------------------------------------------------------------------------------------------------------------------------
# Inhaltsverzeichnis
1.  [ROOT](#root)
1.  [Partitionen](#partitionen)
1.  [Verzeichnisse](#verzeichnisse)
1.  [DLL Dynamic Link Libarie](#dll-dynamic-link-libarie)
      * [DLL Hölle](#dll-hölle)
1.  [Mount](#mount)
      * [USB Stick Mount](#usb-stick-mount)
      * [USB Stick Unmount](#usb-stick-unmount)
1.  [Neuer Benutzer](#neuer-benutzer)
1.  [Rechte](#rechte)
      * [Dateirechten](#dateirechte)
      * [Verzeichnissrechte](#verzeichnissrechte)
...
## DLL Hölle
DLL´s erkennen ältere Dateien nicht daher speichern sie einfach die alten und neuen Dateien was zu rießigem Speicherverbrauch führt.
...
Die 9 Buchstaben für die Zugriffsrechte teilen sich in:
...
root@pcxx:~# ll /mnt
insgesamt 8
drwxr-xr-x  2 root root 4096 Okt 22  2018 ./
drwxr-xr-x 25 root root 4096 Sep 29 11:32 ../
```

---------------------------------------------------------------------------------------------------------
## Rechte Ändern
Dateirechte und Verzeichnisrechte können mit dem Kommando chmod geändert werden. Das Kommando lässt sich in einer Vielzahl von Variationen anwenden.
Rechte können im Oktalen und Symbolischen System geändert werden.

-----------------------------------------------------------------------------------------------------------------
### Oktal
![oktal](https://www.tutonaut.de/wp-content/uploads/2014/05/rechte-unter-linux.jpg)

Beispiel:
```
schueler@pcxx:~$ chmod 757 /home/schueler
```
...
+ -> Recht erteilen, - -> Recht entfernen
...
Beispiel:
```
schueler@pcxx:~$ ls -l /home
insgesamt 8
drwxr-xrwx 25 schueler schueler 4096 Okt 14 14:45 schueler
drwxr-xr-x  4 wade     wade     4096 Okt 14 15:24 wade
schueler@pcxx:~$ chmod o-rwx /home/schueler
```
Weitere Infos Unter:
