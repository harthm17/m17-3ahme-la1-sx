...
5. [Git](#git)
    * [Remote Repository--> Repository am Server nicht ~Lokal~](#remote_repository-->_repository_am_server-nicht_~Lokal)
    * [Stash](#stash)
    * [Workplace](#workplace)
    * [Index](#index)
    * [Local Repository](#local_repository)
6. [Shell Kommandos](#shell_kommandos)
7. [Was ist ein Branch?](#was_ist_ein_branche?)
8. [Was ist ein Merge?](#was_ist_ein_merge?)
