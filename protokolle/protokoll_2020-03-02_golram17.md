...
-----------------------------------------------
  ...
  ````
  In dem Verzeichnis ````.ssh/config```` werden die Dateien zum einloggen auf dem Computer gespeichert. Die Datei ssh/config speichert sich der Computer die Vereinfachte Version des einloggens.
  ````bash
